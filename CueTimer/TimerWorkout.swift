...
//    
//    func startTimer() {
//        print("Timer fired: remainingTime=\(remainingTime)")
//        isTimerRunning = true
...
//                    self.timeElapsed += 1
//                    print("Time elapsed")
//                } else if self.remainingTime == 1 && !(self.curr + 1 < self.timerSegments.count) {
//                    self.timeElapsed += 1
//                    self.cueWorkout.setCurr(newCurr: self.total)
//                } else {
//                    if self.curr + 1 < self.timerSegments.count {
